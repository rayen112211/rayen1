...
export const translations = {
    ...
    ar: {
        ...
        hero: {
            ...
            titleStart: "مواقع إلكترونية تحول",
            titleEnd: "الزوار إلى عملاء.",
            subtitle: "أقوم ببناء مواقع إلكترونية متميزة عالية الأداء مصممة لتنمية أعمالك. توقف عن خسارة العملاء لمواقع بطيئة وقديمة.",
            ctaPrimary: "احصل على عرض سعر",
            ctaSecondary: "مشاهدة أعمالي",
            card: {
                title: "نمو الأعمال",
                subtitle: "محسن للتحويل والسرعة",
                performance: "الأداء",
                seo: "سيو",
                secure: "آمن",
                ssl: "جاهز لـ SSL",
        ...
        about: {
            title: "ريان العزازي",
            role: "مطور فول ستاك ومخطط رقمي",
            quote: "\"أنا لا أكتب الأكواد فحسب، بل أبني أصولاً رقمية تجلب لك المزيد من الأرباح.\"",
            whoAmI: {
                title: "من أنا؟",
                subtitle: "شريكك التقني.",
                p1: "لست مجرد مطور كود يسلمك قالباً جاهزاً. أنا مطور مخلص يدرك أن موقعك الإلكتروني هو استثمار حقيقي.",
                p2: "هدفي هو جعل عملك يبرز في سوق مزدحم. أركز على السرعة والتصميم وتجربة المستخدم لضمان كسب ثقة الزوار فوراً."
            },
            cards: {
                results: { title: "نتائج ملموسة", desc: "تركيز على العائد الاستثماري والسرعة وتصدر نتائج البحث." },
                business: { title: "عقلية ريادية", desc: "أتحدث لغتك العملية، وليس فقط لغة الأكواد." },
                tech: { title: "تقنيات حديثة", desc: "مبني بأحدث وأسرع التقنيات العالمية." },
                expertise: { title: "خبرة هندسية", desc: "تعلم مستمر وهندسة برمجية احترافية." }
            }
        },
        services: {
            label: "ما الذي أقدمه",
            title: "حلول شاملة لـ",
            titleGradient: "الأعمال الحديثة",
            description: "أنا لا أبيع فقط \"مواقع إلكترونية\". أنا أوفر البنية التحتية الرقمية التي يحتاجها عملك للنمو والعمل بكفاءة والتوسع.",
            items: [
                {
                    id: 1,
                    title: "منصات أعمال مخصصة",
                    description: "تجاوز القوالب الجاهزة. أقوم ببناء تطبيقات ويب مخصصة لاحتياجاتك التشغيلية—سواء كانت بوابة عملاء، نظام حجز، أو لوحة بيانات معقدة.",
                    features: ["معمارية React/Next.js", "تصميم قواعد بيانات قابلة للتوسع", "نظام توثيق مستخدمين آمن"]
                },
                {
                    id: 2,
                    title: "تجارة إلكترونية عالية التحويل",
                    description: "أطلق متجراً إلكترونياً يبيع حقاً. من عرض المنتجات إلى معالجة الدفع الآمن، أبني تجارب تسوق يثق بها العملاء.",
                    features: ["ربط مع Stripe/PayPal", "تحسين سلة الشراء والدفع", "لوحة تحكم للمدير"]
                },
                {
                    id: 3,
                    title: "سيو احترافي ونمو",
                    description: "الموقع الجميل لا فائدة منه إذا لم يجده أحد. أقوم بتنفيذ سيو تقني يضمن تصدر عملك لنتائج بحث جوجل ووصول الزوار بشكل طبيعي.",
                    features: ["استراتيجية تصدر بحث جوجل", "تحسين الكلمات المفتاحية", "ضبط أداء الموقع"]
                },
                {
                    id: 4,
                    title: "أتمتة سير العمل",
                    description: "توقف عن تكرار المهام اليدوية. أقوم بربط موقعك مع أدوات مثل CRMs وأنظمة التسويق عبر البريد الإلكتروني لجعل عملك يعمل تلقائياً.",
                    features: ["ربط عبر API", "رسائل بريد تلقائية", "تنبيهات فورية"]
                }
            ]
        },
        caseStudy: {
            label: "قصة نجاح مختارة",
            title: "Unyamee.shop – منظومة تجارة عالمية",
            challenge: "كان العميل بحاجة إلى منصة تجارة إلكترونية عالمية قادرة على التعامل مع معاملات متعددة العملات، تتبع المخزون اللحظي لآلاف المنتجات، وتجربة تسوق سلسة للهواتف.",
            solutionTitle: "الحل",
            solution: "قمت بصياغة حل تقني مخصص باستخدام React و Python. شملت الميزات محرك فلترة ديناميكي، نظام دفع آمن مع Stripe، ولوحة تحكم قللت وقت إدارة المخزون بنسبة 40%.",
            visitSite: "زيارة الموقع",
            salesLive: "المبيعات",
            live: "مباشر",
            results: [
                "زيادة 35% في تحويلات الجوال",
                "سرعة تحميل أقل من ثانيتين",
        ...
        pricing: {
            ...
            title: "شفافية وأسعار قائمة",
            titleGradient: "على القيمة.",
            description: "اختر الطريقة التي تفضل العمل بها. أقدم نموذجاً مرناً يفصل تكلفة البناء عن الصيانة المستمرة، مما يمنحك تحكماً كاملاً في ميزانيتك.",
            ...
            plans: [
                {
                    ...
                    title: "الأساس",
                    price: "€400 - €1.200",
                    paymentStructure: "50% مقدماً • 50% عند التسليم",
                    description: "الاستثمار الأساسي. أقوم بتصميم وبناء منصتك المخصصة من الصفر. أنت تملك 100% من الكود والأصول للأبد.",
                    features: ["تصميم UI/UX مخصص", "تطوير متوافق مع الجوال", "إعداد بنية السيو", "تهيئة لوحة التحكم", "دفع لمرة واحدة"],
                    badge: ""
                },
                {
                    type: "صيانة اختيارية",
                    title: "راحة البال",
                    price: "تبدأ من 50€ شهرياً",
                    description: "قم بتأمين استثمارك. أتولى إدارة الاستضافة والتحديثات والمشاكل التقنية لضمان استمرارية عمل موقعك.",
                    features: ["استضافة ممتازة عالية السرعة", "إدارة اسم النطاق", "تحديثات أمنية أسبوعية", "مراقبة التوفر 24/7", "إلغاء في أي وقت"],
                    badge: "إضافة موصى بها"
                }
            ]
        },
        faq: {
            title: "أسئلة شائعة",
            description: "الشفافية هي مفتاح الشراكة الجيدة. إليك إجابات صادقة على الأسئلة الأكثر طرحاً.",
            moreQuestions: "لديك سؤال آخر؟",
            items: [
                {
                    question: "هل يلزمني دفع الرسوم الشهرية؟",
                    answer: "لا، الأمر اختياري بنسبة 100%. يمكنك اختيار الدفع فقط للبناء وإدارة الاستضافة بنفسك. ومع ذلك، مقابل 50 يورو شهرياً فقط، أضمن بقاء موقعك سريعاً وآمناً دون أن تضطر لفعل أي شيء."
                },
                {
                    question: "كم يستغرق بناء الموقع؟",
                    answer: "يستغرق الموقع القياسي عادة من 4 إلى 7 أيام. المنصات المعقدة ذات الميزات المخصصة (مثل أنظمة الحجز) تستغرق عادة من أسبوع إلى 3 أسابيع."
                },
                {
                    question: "من يملك الموقع؟",
                    answer: "أنت تملكه. بمجرد دفع رسوم البناء لمرة واحدة، تملك 100% من الكود والتصميم والمحتوى. لا توجد عقود ملزمة."
                },
                {
                    question: "هل يمكنك مساعدتي في تصدر نتائج جوجل؟",
                    answer: "بالتأكيد. خدمة السيو الاحترافية مدمجة في عملية التطوير لدينا. أضمن أن موقعك محسن تقنياً لخوارزميات جوجل منذ اليوم الأول."
                }
            ]
        },
        contact: {
            label: "ابدأ التحول الرقمي",
            title: "جاهز لتوسيع رقعة",
            titleGradient: "تواجدك الرقمي؟",
            description: "أنت ركز على إدارة عملك. وأنا سأتولى التكنولوجيا التي تساعده على النمو. دعنا نناقش مشروعك اليوم.",
            emailBtn: "راسلني بالبريد",
            whatsappBtn: "واتساب",
            responseTime: "وقت الرد: أقل من 24 ساعة",
            location: "المقر في إيطاليا، نخدم العملاء في جميع أنحاء العالم."
        },
        footer: {
            tagline: "أنا لا أكتب الأكواد فحسب، بل أبني محركات رقمية عالية الأداء تطور أعمالك.",
            explore: "استكشف",
            startScaling: "ابدأ التوسع",
            ctaDescription: "عملك يستحق منصة رقمية قوية. لنبنِها معاً.",
            ctaButton: "تواصل معي",
            rights: "جميع الحقوق محفوظة.",
            designed: "صمم ليحدث تأثيراً."
        }
    }
};
