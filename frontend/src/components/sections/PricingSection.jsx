        ...
        <section id="pricing" className="py-24 bg-[#0f1115] relative overflow-hidden">
            ...
            <div className="container-padding relative z-10">
                <div className="text-center max-w-2xl mx-auto mb-16">
                    <span className="text-accent text-sm font-bold tracking-widest uppercase mb-4 block">Investment Strategy</span>
                    <h2 className="heading-lg text-white mb-6">
                        Transparent, Value-Based <span className="text-gradient">Pricing.</span>
                    </h2>
                    <p className="text-muted-foreground text-lg">
                        Choose how you want to work. I offer a flexible model that separates the build cost from ongoing care, giving you full control over your budget.
                    </p>
                </div>
                    ...
                    {pricing.map((plan) => (
                        ...
                        >
                            ...
                            <div className="space-y-4 mb-8 text-center md:text-left">
                                <p className={`text-sm font-bold tracking-wider uppercase ${plan.highlight ? 'text-primary' : 'text-muted-foreground'}`}>
                                    {plan.type}
                                </p>
                            ...
                            <ul className="space-y-4 mb-8">
                                {plan.features.map((feature, i) => (
                                    <li key={i} className="flex items-start text-sm text-secondary-foreground">
                                        <Check className={`w-5 h-5 mr-3 flex-shrink-0 ${plan.highlight ? 'text-primary' : 'text-white/20'}`} />
                                        <span>{feature}</span>
                                    </li>
                                ))}
                            </ul>
                            ...
                            <a
                                href="#contact"
                                className={`block w-full py-4 rounded-lg text-center font-bold text-sm transition-all duration-300 ${plan.highlight
