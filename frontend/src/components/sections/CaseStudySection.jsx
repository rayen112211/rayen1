            ...
            <div className="relative z-10 group">
              ...
              <div className="glass-card p-2 rounded-2xl border border-white/10 shadow-2xl transition-transform duration-700 group-hover:scale-[1.02]">
                <div className="rounded-xl overflow-hidden aspect-[4/3] lg:aspect-video bg-black relative">
                  {/* Browser Header */}
                  <div className="absolute top-0 left-0 right-0 h-8 bg-black/95 backdrop-blur-sm flex items-center px-4 space-x-2 border-b border-white/10 z-10">
                    <div className="w-2.5 h-2.5 rounded-full bg-red-500" />
                    <div className="w-2.5 h-2.5 rounded-full bg-yellow-500" />
                    <div className="w-2.5 h-2.5 rounded-full bg-green-500" />
                    <div className="mx-auto w-1/2 h-4 bg-white/5 rounded text-[10px] text-center leading-4 flex items-center justify-center">
                      <span className="text-gray-400">unyamee.shop</span>
                    </div>
                  </div>
